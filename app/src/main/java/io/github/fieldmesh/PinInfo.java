...
public class PinInfo {
    ...
    public byte[] encode() {
        ...
        int c3 = (colorVal >> 3) & 0x01;
        int c4 = (colorVal >> 4) & 0x01;
        buffer.put((byte) ((iconVal << 1) | c1));
        buffer.put((byte) ((c0 << 7) | (rotationVal >> 2)));
        buffer.put((byte) (((rotationVal & 0x03) << 6) | (c2 << 5) | (c3 << 4) | (c4 << 3))); // 3 bytes
    ...
    public void decode(byte[] data) {
        ...
        int c3 = ((b3 & 0xFF) >>> 4) & 0x01;
        int c4 = ((b3 & 0xFF) >>> 3) & 0x01;
        this.color = (c4 << 4) | (c3 << 3) | (c2 << 2) | (c1 << 1) | c0;
