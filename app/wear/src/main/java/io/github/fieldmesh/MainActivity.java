...
public class MainActivity extends AppCompatActivity implements MessageClient.OnMessageReceivedListener {
    ...
    private static final String PATH_REQUEST_FULL_SYNC = "/fieldmesh/request_full_sync";
    private static final String PATH_MAP_DATA_BATCH = "/fieldmesh/map_data_batch";
    private static final String PATH_CLEAR_MAP_DATA = "/fieldmesh/clear_map_data";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Configuration.getInstance().setUserAgentValue(io.github.fieldmesh.BuildConfig.APPLICATION_ID);
            Log.i(TAG, "Setting osmdroid User-Agent to: " + io.github.fieldmesh.BuildConfig.APPLICATION_ID);
        } catch (Exception e) {
    ...
    private void processNodeLocationsUpdate(String jsonDataString) {
        ...
        try {
            ...
            for (int i = 0; i < nodesArray.length(); i++) {
                ...
                int nodePinColor = isOld ?  ResourcesCompat.getColor(getResources(), R.color.yellow, null) : Color.rgb(255, 255, 255); // Light Blue for fresh, Gray for old
